...
exports.AttendanceByDateResponseDto = exports.ClassAttendanceByDateDto = exports.AttendanceOverviewResponseDto = exports.StudentBreakdownDto = exports.ClassSummaryDto = exports.SessionSummaryDto = void 0;
...
class ClassAttendanceByDateDto {
    classId;
    className;
    grade;
    sessionId;
    ...
    unsure;
    static _OPENAPI_METADATA_FACTORY() {
        return { classId: { required: true, type: () => String }, className: { required: true, type: () => String }, grade: { required: true, type: () => String }, sessionId: { required: true, type: () => String, nullable: true }, attendanceSubmitted: { required: true, type: () => Boolean }, totalStudents: { required: true, type: () => Number }, present: { required: true, type: () => Number }, absent: { required: true, type: () => Number }, unsure: { required: true, type: () => Number } };
    }
}
exports.ClassAttendanceByDateDto = ClassAttendanceByDateDto;
__decorate([
    (0, swagger_1.ApiProperty)(),
    __metadata("design:type", String)
], ClassAttendanceByDateDto.prototype, "classId", void 0);
__decorate([
    (0, swagger_1.ApiProperty)(),
    __metadata("design:type", String)
], ClassAttendanceByDateDto.prototype, "className", void 0);
__decorate([
    (0, swagger_1.ApiProperty)(),
    __metadata("design:type", String)
], ClassAttendanceByDateDto.prototype, "grade", void 0);
__decorate([
    (0, swagger_1.ApiProperty)({ nullable: true }),
    __metadata("design:type", Object)
], ClassAttendanceByDateDto.prototype, "sessionId", void 0);
__decorate([
    (0, swagger_1.ApiProperty)(),
    __metadata("design:type", Boolean)
], ClassAttendanceByDateDto.prototype, "attendanceSubmitted", void 0);
__decorate([
    (0, swagger_1.ApiProperty)(),
    __metadata("design:type", Number)
], ClassAttendanceByDateDto.prototype, "totalStudents", void 0);
__decorate([
    (0, swagger_1.ApiProperty)(),
    __metadata("design:type", Number)
], ClassAttendanceByDateDto.prototype, "present", void 0);
__decorate([
    (0, swagger_1.ApiProperty)(),
    __metadata("design:type", Number)
], ClassAttendanceByDateDto.prototype, "absent", void 0);
__decorate([
    (0, swagger_1.ApiProperty)(),
    __metadata("design:type", Number)
], ClassAttendanceByDateDto.prototype, "unsure", void 0);
class AttendanceByDateResponseDto {
    date;
    classes;
    static _OPENAPI_METADATA_FACTORY() {
        return { date: { required: true, type: () => String }, classes: { required: true, type: () => [require("./attendance-overview-response.dto").ClassAttendanceByDateDto] } };
    }
}
exports.AttendanceByDateResponseDto = AttendanceByDateResponseDto;
__decorate([
    (0, swagger_1.ApiProperty)(),
    __metadata("design:type", String)
], AttendanceByDateResponseDto.prototype, "date", void 0);
__decorate([
    (0, swagger_1.ApiProperty)({ type: () => [ClassAttendanceByDateDto] }),
    __metadata("design:type", Array)
], AttendanceByDateResponseDto.prototype, "classes", void 0);
