...
const bulk_progress_dto_1 = require("./dto/bulk-progress.dto");
...
__decorate([
    ...
    __param(0, (0, common_1.Body)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [bulk_progress_dto_1.BulkProgressDto]),
    __metadata("design:returntype", Promise)
], ProgressController.prototype, "bulkSave", null);
__decorate([
    (0, common_1.Get)('session'),
    openapi.ApiResponse({ status: 200, type: [require("./dto/progress-list-response.dto").SessionProgressEntryDto] }),
    __param(0, (0, common_1.Query)('classSessionId')),
    __param(1, (0, common_1.Query)('progressMetricId')),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String, String]),
    __metadata("design:returntype", Promise)
], ProgressController.prototype, "findBySession", null);
__decorate([
