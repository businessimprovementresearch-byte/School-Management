...
class MeResponseDto {
    ...
    static _OPENAPI_METADATA_FACTORY() {
        return { user: { required: true, type: () => require("./login-response.dto").UserInfoDto } };
    }
}
exports.MeResponseDto = MeResponseDto;
__decorate([
    (0, swagger_1.ApiProperty)({ type: () => login_response_dto_1.UserInfoDto }),
    __metadata("design:type", login_response_dto_1.UserInfoDto)
