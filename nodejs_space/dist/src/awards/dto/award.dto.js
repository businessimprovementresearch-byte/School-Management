...
exports.AwardIssuanceDto = exports.AwardListItemDto = exports.IssueAwardDto = exports.UpdateAwardDto = exports.CreateAwardDto = void 0;
...
class UpdateAwardDto {
    ...
    icon;
    static _OPENAPI_METADATA_FACTORY() {
        return { name: { required: false, type: () => String }, description: { required: false, type: () => String }, icon: { required: false, type: () => String } };
    }
}
