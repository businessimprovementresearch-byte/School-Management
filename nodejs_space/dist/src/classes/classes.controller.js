...
let ClassesController = class ClassesController {
    ...
    async setYearStatus(classId, academicYearId, dto) {
        return this.classesService.setYearStatus(classId, academicYearId, dto.isActive);
    }
    async create(dto) {
...
__decorate([
    (0, common_1.Patch)(':classId/year-status/:academicYearId'),
    (0, roles_decorator_1.Roles)('ADMIN'),
    ...
    __metadata("design:returntype", Promise)
], ClassesController.prototype, "setYearStatus", null);
__decorate([
    (0, common_1.Post)(),
    (0, roles_decorator_1.Roles)('ADMIN'),
    openapi.ApiResponse({ status: 201, type: require("./dto/class-detail-response.dto").ClassDetailResponseDto }),
