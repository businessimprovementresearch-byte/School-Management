...
class ClassSessionInfoDto {
    ...
    termName;
    static _OPENAPI_METADATA_FACTORY() {
        return { id: { required: true, type: () => String }, date: { required: true, type: () => String }, attendanceSubmitted: { required: true, type: () => Boolean }, isHoliday: { required: true, type: () => Boolean }, termName: { required: true, type: () => String, nullable: true } };
    }
}
...
__decorate([
    (0, swagger_1.ApiProperty)(),
    __metadata("design:type", Boolean)
], ClassSessionInfoDto.prototype, "isHoliday", void 0);
__decorate([
    (0, swagger_1.ApiProperty)({ nullable: true, type: String }),
    __metadata("design:type", Object)
