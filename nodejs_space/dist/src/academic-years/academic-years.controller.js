...
const rollover_academic_year_dto_1 = require("./dto/rollover-academic-year.dto");
...
__decorate([
    openapi.ApiQuery({ name: "force", required: false }),
...
__decorate([
    (0, common_1.Post)(':id/rollover'),
    (0, roles_decorator_1.Roles)('ADMIN'),
    openapi.ApiResponse({ status: 201 }),
    __param(0, (0, common_1.Param)('id')),
    __param(1, (0, common_1.Body)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String, rollover_academic_year_dto_1.RolloverAcademicYearDto]),
    __metadata("design:returntype", Promise)
], AcademicYearsController.prototype, "rollover", null);
