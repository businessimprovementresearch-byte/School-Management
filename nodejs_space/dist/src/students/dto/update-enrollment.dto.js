...
class UpdateEnrollmentDto {
    ...
    static _OPENAPI_METADATA_FACTORY() {
        return { status: { required: false, type: () => String }, classId: { required: false, type: () => String, format: "uuid" } };
    }
}
exports.UpdateEnrollmentDto = UpdateEnrollmentDto;
__decorate([
    (0, class_validator_1.IsEnum)(['ACTIVE', 'COMPLETED', 'WITHDRAWN']),
...
__decorate([
    ...
    (0, class_validator_1.IsOptional)(),
    __metadata("design:type", String)
], UpdateEnrollmentDto.prototype, "classId", void 0);
