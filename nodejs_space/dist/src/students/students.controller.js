...
let StudentsController = class StudentsController {
    ...
    async findAll(req, search, classId, includeInactive, page, limit) {
        const teacherClassIds = await this.getTeacherClassIds(req);
        return this.studentsService.findAll(search, classId, page, limit, teacherClassIds, includeInactive === 'true');
    }
    async findOne(id) {
...
__decorate([
    (0, common_1.Patch)('students/:id/active'),
    (0, roles_decorator_1.Roles)('ADMIN'),
    openapi.ApiResponse({ status: 200, type: require("./dto/student-detail-response.dto").StudentDetailResponseDto }),
    __param(0, (0, common_1.Param)('id')),
    __param(1, (0, common_1.Body)()),
    ...
    __metadata("design:returntype", Promise)
], StudentsController.prototype, "setActive", null);
__decorate([
